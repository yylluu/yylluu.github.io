...
Many my research results are published in top-tier A+ CS conferences (according to CORE ranking), such as ACM PODC, ACM CCS, USENIX Security, and NDSS. An incomplete list of my representative works include:
